...
ui <- fluidPage(
  theme = bslib::bs_theme(
    ...
    base_font = c('Atkinson Hyperlegible','Source Sans Pro',  'Lato', 'Merriweather', 'Roboto Regular', 'Cabin Regular'),
    heading_font = c('Atkinson Hyperlegible', 'Prata', 'Roboto', 'Playfair Display', 'Montserrat'),
    font_scale = 1.25
  ),
  h1('Sources of Electricity, CO2 emissions and GDP'),
  sidebarLayout(
    sidebarPanel(
